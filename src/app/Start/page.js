        ...
        <div className="min-h-screen bg-white">
            <header className="sticky top-0 bg-white z-10 flex flex-col sm:flex-row justify-between items-center px-3 py-2 sm:px-8 sm:py-4 border-b">
                ...
                <div className="flex items-center text-gray-800">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-mono tracking-wider">Need help? Call (415) 523 8837</span>
                </div>
            </header>
            ...
            <main className="max-w-3xl mx-auto px-4 pt-6 sm:pt-8 md:pt-12 text-center">
                ...
                <h1 className="text-xl sm:text-2xl md:text-4xl font-serif italic mb-2 sm:mb-3 md:mb-4 text-gray-900">
                    Hi, I'm Betsy!
                </h1>
                ...
                <div className="space-y-3 sm:space-y-4">
                    {[
                        { icon: "🏠", text: "Buying a home", important: true },
                        { icon: "🔄", text: "Refinance my mortgage", important: true },
                        { icon: "💰", text: "Get cash from my home", important: true }
                    ].map((option, index) => (
                        <button
                            key={index}
                        ...
                        >
                            ...
                            <span className={`text-sm sm:text-base ${option.important ? 'font-serif font-bold tracking-wide' : 'font-medium'}`}>
                                {option.text}
                            </span>
                        </button>
                    ))}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-12 mt-8 sm:mt-12 md:mt-16 px-4">
                    <div className="text-center p-4 rounded-lg bg-gray-50">
                        <div className="text-xl sm:text-2xl md:text-4xl font-serif font-black text-gray-900">$100B</div>
                        <div className="text-gray-700 text-xs sm:text-sm md:text-base mt-1">
                            home loans funded entirely online
                        </div>
                    </div>
                    <div className="text-center p-4 rounded-lg bg-gray-50">
                        <div className="text-xl sm:text-2xl md:text-4xl font-serif font-black text-gray-900">400K</div>
                        <div className="text-gray-700 text-xs sm:text-sm md:text-base mt-1">
